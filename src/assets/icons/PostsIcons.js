export function ThumbsupEmpty() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" strokeWidth="0.1" stroke="currentColor" fill="currentColor" viewBox="0 0 24 24">
...
export function Comments() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" className="bi bi-chat-dots" viewBox="0 0 16 16">
...
export function closeIcon() {
  return (
    <svg style="color: rgb(64, 139, 68);" width="15" height="15" viewBox="0 0 15 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function ImageIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="var(--root-background-color)" className="bi bi-camera" viewBox="0 0 16 16">
...
export function DocumentIcon({ props }) {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 4a2 2 0 0 1 2-2h8a1 1 0 0 1 .707.293l5 5A1 1 0 0 1 20 8v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4zm13.586 4L14 4.414V8h3.586zM12 4H6v16h12V10h-5a1 1 0 0 1-1-1V4z" fill="currentColor" />
    </svg>
  )
}

export function ChevromDown() {
  return (
...
export function ChevronLeft() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill='var(--root-theme-color)' className="bi bi-chevron-left" viewBox="0 0 16 16">
...
export function ChevronRight() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill='var(--root-theme-color)' className="bi bi-chevron-right" viewBox="0 0 16 16">
...
export function Message() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
